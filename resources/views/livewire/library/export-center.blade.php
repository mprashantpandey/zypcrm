<div class="py-10 bg-gray-50/50 min-h-screen">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
        <div>
            <h1 class="text-2xl font-bold text-gray-900 tracking-tight">Library Data Exports</h1>
            <p class="mt-1 text-sm text-gray-500">Export your library students, attendance, leaves, payments, and invoices.</p>
        </div>
