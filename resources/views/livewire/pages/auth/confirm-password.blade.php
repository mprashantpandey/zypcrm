...
<div>
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-gray-900 tracking-tight">Confirm Password</h1>
        <p class="mt-1 text-sm text-gray-500">Security check before entering this section.</p>
    </div>
